...
event OnGameReload()
	if (!_initialized)
		...
		; YeOlde
		_fileName = OPTIONS_DEFAULT_BACKUP_FILE
...
function SetMenuIndex(int a_index)
	string optionState = _stateOptionMap[_activeOption % 0x100]
	Log("SetMenuIndex(" + a_index + ") -> state: " + optionState + ", activeOption: " + _activeOption + ", optionIndex: " + (_activeOption % 0x100))
