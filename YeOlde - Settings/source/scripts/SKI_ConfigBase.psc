...
; YeOlde
function Enable()
    Debug.Trace("yeolde_SKI_ConfigBase::Enable -> " + ModName)
    _isEnabled = true

    if (_configManager != none)
        _configManager.EnableMod(self, ModName)
    endif
endfunction
...
; YeOlde
function Disable()
    Debug.Trace("yeolde_SKI_ConfigBase::Disable -> " + ModName)
    _isEnabled = false

    if (_configManager != none)
        _configManager.DisableMod(self, ModName)
    endif
endfunction
