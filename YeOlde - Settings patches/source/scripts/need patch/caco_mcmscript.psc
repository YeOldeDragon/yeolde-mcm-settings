...
function OnBackupRequest(int jMod)
	Debug.Trace("CACO::OnBackupRequest(" + jMod + ")")
	...
	Debug.Trace("CACO::OnBackupRequest() -> COMPLETED")
endfunction

function OnRestoreRequest(int jMod)
	Debug.Trace("CACO::OnRestoreRequest(" + jMod + ")")
	...
	Debug.Trace("CACO::OnRestoreRequest() -> AdjustedMinVal:" + AdjustedMinVal)
	...
	Debug.Trace("CACO::OnRestoreRequest() -> COMPLETED")
endfunction
